...
HD_PWD='C:/Users/Emma/Desktop/project_WashingMachine/project_WashingMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log washing_machine_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source washing_machine_controller.tcl
