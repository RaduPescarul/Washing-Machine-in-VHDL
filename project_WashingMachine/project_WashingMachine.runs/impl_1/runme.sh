...
HD_PWD='C:/Users/Emma/Desktop/project_WashingMachine/project_WashingMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log washing_machine_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source washing_machine_controller.tcl -notrace
